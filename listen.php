...
<div id="sidebar2"><h2>To listen to the messages just click on the message.  For more player control, right-click (mp3) and select "open in new window/tab".  To download select "save target/link as".</h2>
        
<div id="sp_media">
    <ul>
        <li id="sp_track"><h2>Worship Forever</h2><img src="img/rob_b.jpg"><br><a href="http://www.myberean.com/audio/mp3/WorshipForever.mp3">Download MP3</a></li>
    </ul>
</div>
</div>
